...
<head>
	...
	<meta name="description" content="SRI VINAYAK WHEELS">
	<meta name="author" content="SRI VINAYAK WHEELS">
	<meta name="keywords" content="SRI VINAYAK WHEELS">
	<!-- Favicon -->
	<link rel="icon" href="<?php echo base_url() ?>assets/admin_assets/logo/logo.webp" />
	<!-- Title -->
					...
					<div class="card">
						<div class="">
							<div class="card-body mt-2 mb-2 p-5">
								...
								<h2 class="mg-b-20 text-danger">SRI VINAYAK WHEELS</h2>
