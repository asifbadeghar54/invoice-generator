$(function() {
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			...
			datasets: [{
				...
				borderColor: "rgb(33, 79 ,190)",
				borderWidth: "0",
				backgroundColor: "rgb(33, 79 ,190)"
			}, {
				label: "Data2",
				data: [28, 48, 40, 19, 86, 27, 90],
				borderColor: "rgb(229, 77 ,38)",
				borderWidth: "0",
				backgroundColor: "rgb(229, 77 ,38)"
			}]
		},
		options: {
			responsive: true,
	...
	var datapie = {
		...
		datasets: [{
			data: [20, 20, 30, 5, 25],
			backgroundColor: ['rgb(33, 79 ,190)', 'rgb(229, 77 ,38)', '#5f1dd7', '#269c8e', '#fe4100']
		}]
	};
	var optionpie = {
		maintainAspectRatio: false,
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			datasets: [{
				data: [18, 15, 9, 6, 19],
				backgroundColor: ['rgb(33, 79 ,190)', 'rgb(229, 77 ,38)', '#6924ec', '#269c8e', '#fe4100'],
				hoverBackgroundColor: ['rgb(33, 79 ,190)', 'rgb(229, 77 ,38)', '#6924ec', '#269c8e', '#fe4100'],
